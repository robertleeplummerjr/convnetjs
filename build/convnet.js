...
(function(global) {
  ...
  var Vol = function(sx, sy, depth, c, isFilter) {
    var setup = false;
    ...
    if(Object.prototype.toString.call(sx) === '[object Array]') {
      ...
      this.depth = depth;
      var n = sx*sy*depth;
      this.w = false ? new Proxy(global.zeros(n), {
...
(function(global) {
  ...
  var ConvLayer = function(opt) {
    ...
    for(var i=0;i<this.out_depth;i++) {
      var filter = new Vol(this.sx, this.sy, this.in_depth, undefined, true);
  ...
  var con = new ConvLayer({
    sx:5,filters:8,stride:1,pad:2,activation:"relu",bias_pref:0.1,in_sx:2,in_sy:2,in_depth:1
  });

  con.filters.forEach((filter, filterIndex) => {
    for (var wIndex = 0; wIndex < filter.w.length; wIndex++) {
  ...
  var FullyConnLayer = function(opt) {
    ...
    this.filters = [];
    for(var i=0;i<this.out_depth ;i++) {
      var filter = new Vol(1, 1, this.num_inputs, undefined, true);
      filter.isFilter = true;
      this.filters.push(filter);
    }
    this.biases = new Vol(1, 1, this.out_depth, bias);
  ...
  FullyConnLayer.prototype = {
    ...
    backward: function() {
      ...
      for(var i=0;i<this.out_depth;i++) {
        ...
        for(var d=0;d<this.num_inputs;d++) {
          console.log(tfi.dw[d], V.w[d], chain_grad);
